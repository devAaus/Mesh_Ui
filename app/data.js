export const data = [
    ...
    },
    {
        ...
        code: <div class="group relative">
            ...
            <span class="absolute -top-14 left-[50%] -translate-x-[50%] z-20 origin-left scale-0 px-3 rounded-lg border border-gray-300 bg-white py-2 text-sm font-bold shadow-md transition-all duration-300 ease-in-out group-hover:scale-100">GitHub<span>
            </span></span></div>
    },
    {
        id: 4,
    ...
    },
    {
        ...
        >
            ...
            <div
                class="w-[50%] h-[2px] bg-black rounded-sm transition-all duration-300 origin-center rotate-90 -translate-x-[0.3rem] translate-y-[0.1rem] peer-checked:translate-y-[0.1rem]"
            ></div>
            <div
                class="w-[50%] h-[2px] bg-black rounded-md transition-all duration-300 origin-center rotate-90 translate-x-[0.3rem] -translate-y-[0.05rem] peer-checked:rotate-[-30deg] peer-checked:translate-y-[0.22rem] peer-checked:translate-x-[0.15rem]"
            ></div>
            <div
                class="w-[50%] h-[2px] bg-black rounded-md transition-all duration-300 origin-center rotate-90 translate-x-[0.3rem] -translate-y-[0.16rem] peer-checked:rotate-[30deg] peer-checked:translate-y-[-0.4rem] peer-checked:translate-x-[0.15rem]"
            ></div>
        </label>
    ...
    },
    {
        ...
        code: <section class="flex justify-center items-center">
            <button
                href="/"
                class="group flex justify-center p-2 rounded-md drop-shadow-xl bg-[#1ED760] from-gray-800 to-black text-white font-semibold hover:translate-y-3 hover:rounded-[50%] transition-all duration-500 hover:from-[#331029] hover:to-[#310413]"
            >
                <svg
    ...
    },
    {
        ...
        code: <button class="cta flex items-center relative m-auto px-[18px] py-[12px] [transition:all_0.2s_ease] bg-none cursor-pointer before:content-[''] before:absolute before:top-0 before:left-0 before:block before:rounded-[50px] before:bg-[#b1dae7] before:w-[50px] before:h-[50px] before:[transition:all_0.2s_ease] hover:before:w-[100%] hover:before:bg-[#b1dae7] group active:scale-[0.95]">
            ...
            <svg class="relative top-[0] ml-[10px] text-[#234567] -translate-x-[5px] [transition:all_0.3s_ease] group-hover:translate-x-0" width="15" height="10" viewBox="0 0 13 10">
                <path class="stroke-current" d="M1,5 L11,5"></path>
                <polyline class="stroke-current" points="8 1 12 5 8 9"></polyline>
            </svg>
        </button>
    },
    {
